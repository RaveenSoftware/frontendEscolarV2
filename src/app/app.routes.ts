...
import { AdministratorManagementComponent } from './components/administrator/administrator.component';
...
export const routes: Routes = [
  ...
  { path: 'administrators' , component: AdministratorManagementComponent, canActivate:[AuthGuard], data: {userType: 'admin'}},
